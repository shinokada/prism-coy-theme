...
var readTitleFromHeading = function (tree) {
    ...
    var children = __spreadArray([], heading.children);
    heading.children = heading.children.filter(function (child) { return child.type !== 'footnote'; });
    var text = mdast_util_to_string_1.default(heading);
...
var mdast = function () { return function (tree, file) {
    unist_util_visit_1.default(tree, ['yaml'], function (node) {
        var value = js_yaml_1.load(node.value, { schema: js_yaml_1.JSON_SCHEMA });
    ...
    unist_util_visit_1.default(tree, ['shortcode'], function (node) {

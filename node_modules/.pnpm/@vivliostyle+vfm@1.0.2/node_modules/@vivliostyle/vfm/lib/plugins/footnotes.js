...
var replaceFootnoteLinks = function (tree) {
    var sups = hast_util_select_1.selectAll('sup[id^="fnref-"]', tree).filter(function (node) { return node.children.length === 1 && node.children[0].tagName === 'a'; });
...
var replaceFootnotes = function (tree) {
    var area = hast_util_select_1.select('div.footnotes', tree);
    ...
    var items = hast_util_select_1.selectAll('section.footnotes ol li', tree);

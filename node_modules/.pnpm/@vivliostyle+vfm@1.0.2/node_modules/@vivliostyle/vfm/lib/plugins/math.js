...
var mdast = function () {
    ...
    return function (tree) {
        mdast_util_find_and_replace_1.default(tree, REGEXP_INLINE, function (_, valueText) {
            return {
                type: TYPE_INLINE,
                data: {
                    hName: TYPE_INLINE,
        ...
        mdast_util_find_and_replace_1.default(tree, REGEXP_DISPLAY, function (_, valueText) {
            return {
                type: TYPE_DISPLAY,
                data: {
                    hName: TYPE_DISPLAY,
...
var handlerInlineMath = function (h, node) {
    ...
    }, [unist_builder_1.default('text', "\\(" + node.data.value + "\\)")]);
};
...
var hast = function () { return function (tree) {
    if (!(hast_util_select_1.select('[data-math-typeset="true"]', tree) || hast_util_select_1.select('math', tree))) {
        return;
    }
    unist_util_visit_1.default(tree, 'element', function (node) {
        switch (node.tagName) {
            case 'head':
                node.children.push({
                    type: 'element',
